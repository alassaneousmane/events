jQuery(function () {
    ...
    var larails = {
        ...
        initialize: function()
        {
            $('a[data-method]').on('click', this.handleMethod); // Sans paramètre pour dire que je ne vais l'appeler maintenant mais quand on aura cliqué
        },
        ...
        handleMethod: function(e)
        {
            ...
            // data permet de récupérer l'attribut customizé data-*
            var link = $(this),
