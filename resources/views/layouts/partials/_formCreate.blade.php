<form action="{{ route('events.store') }}" method="POST">
	...
	<div class="form-group">
		...
		<textarea name="description" id="" cols="30" id="description" rows="10" placeholder="Description de l'évènement" class="form-control {{ $errors->has('description') ? 'is-invalid' : ''}}">{{ old('description')}}
		</textarea>
